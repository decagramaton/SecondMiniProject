...
public class RecommendPackageViewHolder extends RecyclerView.ViewHolder {
    private int productNo;
    private ImageView image;
    private TextView title;
    private TextView price;

    public RecommendPackageViewHolder(@NonNull View itemView, RecommendPackageAdapter.OnItemClickListener onItemClickListener) {
        super(itemView);
