...
public class TimeDealPackageViewHolder extends RecyclerView.ViewHolder {
    private int productNo;
    private ImageView image;
    private TextView title;
    private TextView price;

    public TimeDealPackageViewHolder(@NonNull View itemView, TimeDealPackageAdapter.OnItemClickListener onItemClickListener) {
        super(itemView);
